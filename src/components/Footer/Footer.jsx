    ...
    <footer className=" mt-auto bg-[#000000b9] p-4">
      <div className="container mx-auto flex flex-wrap items-center gap-y-6 gap-x-12 text-center justify-between">
        <div className='text-left'>
          <Link to="#" className="text-black px-2 rounded-sm">
            {/* AC<span className="font-body">~</span> */}
            <img src="../src/assets/logo.png" className="h-10 rounded-sm skew-x-[-12deg]" alt="" />
          </Link>
          <p className='font-josefin-sans mt-[-8px] text-gray-300'>Transforming ideas into reality.</p>
        </div>
      ...
      <div className="text-center text-gray-300 font-josefin-sans">
        <p>
          Copyright &copy; 2024 <span className='italic'>AC</span><span className='font-body italic'>~</span>
        </p>
        <p className='mt-1'>Designed by <span className='text-white font-normal'>AnujChaudhary</span></p>
      </div>
    </footer>
  )
}
