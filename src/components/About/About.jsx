  ...
  return (
    <>
      <section className='bg-cover bg-center bg-no-repeat min-h-[45vh] md:min-h-[65vh] flex flex-col justify-center items-center shadow-lg shadow-black  bg-opacity-80' style={{ backgroundImage: `url(${about_bg})` }}>
        <h1 className='text-4xl md:text-[40px] lg:text-5xl font-bold mb-3 mt-14'>About Me</h1>
        <Breadcrumbs
    ...
    <div className='container px-4 mx-auto my-8'>
      <h1 className='font-josefin-slab font-extrabold text-4xl text-center mx-16 my-10'>Know Who <span className='text-secondary whitespace-nowrap underline'>I Am</span></h1>
