    ...
    return (
        <div className='rounded-md relative pt-8 pb-16 md:pb-10 mt-14 w-[340px] bg-[#010b139f] border border-[#ffffff25] md:shadow-custom-card'>
            ...
            <div className='relative -top-16'>
                <img src={laptopImg} alt="project1" className='object-cover object-center' loading='lazy' />
                <img src={mobileImg} alt="project1" className='h-44 absolute object-cover object-center top-10 right-0' loading='lazy' />
            </div>
