...
function Connect() {
    return (
        <div className='rounded-xl py-12 md:py-16 px-2 flex flex-col items-center shadow-xl  bg-gradient-to-tr from-[#0c1821] to-[#0c182160] shadow-[#00000057] relative mb-14' >
