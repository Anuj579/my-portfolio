...
function Connect() {
    return (
        <div className='rounded-md py-12 md:py-16 px-2 text-center flex flex-col items-center shadow-xl bg-[#0c1821] shadow-[#00000057] relative' >
            ...
            <h1 className='text-4xl font-cairo font-bold mb-8 md:mb-10'>Let's <span className='underline text-secondary'>Connect</span></h1>
