...
function Connect() {
    return (
        <div className='rounded-xl py-12 md:py-16 px-2 flex flex-col items-center shadow-xl  bg-gradient-to-tr from-primary to-[#010b138a] shadow-[#00000057] relative mb-14' >
